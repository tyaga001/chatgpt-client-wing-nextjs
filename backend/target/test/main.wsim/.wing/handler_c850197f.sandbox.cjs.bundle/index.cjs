...
// target/test/main.wsim/.wing/inflight.$Closure2-1.cjs
var require_inflight_Closure2_1 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure2-1.cjs"(exports2, module2) {
    "use strict";
    var $helpers = require_helpers();
    module2.exports = function({ $expect_Util, $fn }) {
      class $Closure2 {
        static {
...
// ../../../AppData/Roaming/npm/node_modules/winglang/node_modules/@winglang/sdk/lib/expect/assert.js
var require_assert = __commonJS({
  "../../../AppData/Roaming/npm/node_modules/winglang/node_modules/@winglang/sdk/lib/expect/assert.js"(exports2) {
    "use strict";
    var __importDefault = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var Util = class {
       ...
       */
      static nil(actual) {
        strict_1.default.ok(actual === null || actual === void 0, `Expected "${actual}" to be nil`);
      }
      /**
      ...
      static notNil(actual) {
        strict_1.default.ok(actual !== null && actual !== void 0, `Expected "${actual}" to be not nil`);
      }
      constructor() {
      }
    };
...
// target/test/main.wsim/.wing/handler_c850197f.sandbox.cjs
var $handler = void 0;
exports.handler = async function(event) {
  $handler = $handler ?? await (async () => {
    const $Closure2Client = require_inflight_Closure2_1()({
      $expect_Util: require_assert().Util,
      $fn: function() {
