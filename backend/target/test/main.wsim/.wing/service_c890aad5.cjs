      ...
      exports.start = async function() {
        ...
        const client = await 
          ...
          require("/Users/ankurtyagi/dev/wing/blog/myChatGPTClient/backend/target/test/main.wsim/.wing/inflight.$Closure1-4.cjs")({
  ...
  return require("@winglang/sdk/lib/simulator/client").makeSimulatorClient(simulatorUrl, handle, caller);
            ...
            $utils_Utils: 
      require("/Users/ankurtyagi/dev/wing/blog/myChatGPTClient/backend/target/test/main.wsim/.wing/inflight.Utils-2.cjs")({
      })
    ,
          })
        ;
