...
// ../../../AppData/Roaming/npm/node_modules/winglang/node_modules/@winglang/sdk/lib/target-sim/queue.setconsumer.inflight.js
var require_queue_setconsumer_inflight = __commonJS({
  "../../../AppData/Roaming/npm/node_modules/winglang/node_modules/@winglang/sdk/lib/target-sim/queue.setconsumer.inflight.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.QueueSetConsumerHandlerClient = void 0;
    var QueueSetConsumerHandlerClient = class {
      static {
        __name(this, "QueueSetConsumerHandlerClient");
      }
      constructor({ handler }) {
      ...
      async handle(event) {
        ...
        return batchItemFailures.length > 0 ? JSON.stringify(batchItemFailures) : void 0;
      }
    };
...
// target/test/main.wsim/.wing/inflight.$Closure1-1.cjs
var require_inflight_Closure1_1 = __commonJS({
  "target/test/main.wsim/.wing/inflight.$Closure1-1.cjs"(exports2, module2) {
    "use strict";
...
// target/test/main.wsim/.wing/setconsumer0_c870ccf6.sandbox.cjs
var $handler = void 0;
exports.handler = async function(event) {
  $handler = $handler ?? new (require_queue_setconsumer_inflight()).QueueSetConsumerHandlerClient({
    handler: await (async () => {
